...
if(count($_POST)>0) {
    mysqli_query($conn, "UPDATE student SET StudentID='".$_POST['StudentID']."', Student_Name='".$_POST['Student_Name']."', SupervisorID='".$_POST['SupervisorID']."', IndustrialID='".$_POST['IndustrialID']."' WHERE StudentID='".$_POST['StudentID']."'");
...
<html>
    <head>
        ...
        <title>Edit Student Supervisor</title>
    ...
    <body>
        ...
        <div class="vertical-menu">
            ...
            <main>
                <h3 align="center">Edit Student-Supervisor</h3>
                    <div>
                        ...
                        <div><?php if(isset($message)) { echo "<script>alert('".$message ."')</script>" ; } ?></div>
                            ...
                            <br><br>
                            Supervisor ID: <br>
                            <input type="text" name="SupervisorID" placeholder="Enter Supervisor ID"  required value="<?php echo $row['SupervisorID'];?>" >
                            <br><br>
                            Industrial ID: <br>
                            <input type="text" name="IndustrialID" placeholder="Enter Industrial ID" required value="<?php echo $row['IndustrialID'];?>" >
                            <br><br>
                            <input type="submit" name="update" value="Update" > <input type="button" name="back" value="Back" onclick="window.location.href='student-supervisor.php'">
                        </form>
                    </div>
