...
<html>
    ...
    <body>
        ...
        <div class="vertical-menu">
            ...
            <main>
                <form action="search_result_evaluator.php" method="POST">
                <div class="search-bar">
                    ...
                    <table align="center" class="stud-table">
                        ...
                        <?php
                        $sql= "SELECT student.StudentID, student.Student_Name, student.Faculty_Code, evaluator.EvaluatorID, evaluator.Evaluator_Name, industrial.IndustrialID, industrial.Industry_Name 
                        FROM student 
                        ...
                        while($row = mysqli_fetch_array($result)) { ?>
                            <tr>
                                ...
                                <td><a href="edit_evaluator.php?StudentID=<?php echo $row['StudentID']; ?>" >Edit</a></td>
                                <td><a href="delete_evaluator.php?StudentID=<?php echo $row['StudentID']; ?>" onclick="return confirm('Are you sure you want to delete this row?');">Delete</a></td>
                            </tr>
                        <?php } ?>
